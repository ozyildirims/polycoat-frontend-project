...
export const blogPosts: BlogPost[] = [
    {
        id: 1,
        title: "Tomorrow first: Is the future of logistics here?",
        category: "Logistics Intelligence",
        date: "Dec 21, 2025",
        image: "/news_1.png",
        content: `Despite the recent slowdown caused by the Covid-19 pandemic and ongoing supply chain disruptions, the global transport and logistics sector market is set to grow robustly from around $8tn in 2020 to around $12.8tn in 2025, according to a report by strategy& titled, ‘Modernizing Gulf Logistics Through Digitization’.
...
Going forward, the future of logistics seems centred on efficiencies and peer-to-peer servicing, says Ashrith Sudhir, Marketing Manager, IQ Fulfillment. “These will be enabled by technologies such as automation (at the warehouse, transportation, etc.) and IoT that allows multi-platform connectivity and end-to-end planning cycles. Such initiatives will allow for better resource utilisation, waste elimination and ultimately, an efficient global supply chain.”`
    },
    {
        ...
        date: "Dec 21, 2025",
        image: "/news_2.png",
        content: `Business rules can apply to many aspects of an organization and can be expressed in a variety of ways. In general, business rules define specific instructions or constraints on how certain day-to-day actions should be performed.
...
In traditional approaches, these decisions can be hard-coded directly as part of process designs, leading to complex implementations that require developers to make manual updates as they arise. When complex logic is modeled as a table, it provides a much more relatable and visual format that is easier to maintain for both business and IT.`
    },
    {
        ...
        date: "Dec 21, 2025",
        image: "/news_3.png",
        content: `If you are just starting out and a little nervous about the market with the information flood that you have probably exposed yourself to, this is the right place for you to be.
