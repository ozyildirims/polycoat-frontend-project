            ...
            <section className="relative h-[60vh] flex items-center overflow-hidden">
                ...
                <div className="container mx-auto px-8 md:px-16 relative z-10">
                    <div className="max-w-3xl">
                        <span className="text-secondary font-black text-[10px] tracking-[0.6em] uppercase mb-4 block reveal-up">Corporate Intelligence</span>
                        ...
                        {blogPosts.map((post, index) => (
                            <div key={post.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-24 items-center`}>
                                ...
                                <div className="lg:w-1/2">
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-bold text-primary mb-8 leading-tight">{post.title}</h2>
